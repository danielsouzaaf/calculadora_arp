...
#define comprimentocirculo 6
extern  int * comprimentocirculo_1(operands *, CLIENT *);
extern  int * comprimentocirculo_1_svc(operands *, struct svc_req *);
#define areacirculo 7
extern  int * areacirculo_1(operands *, CLIENT *);
extern  int * areacirculo_1_svc(operands *, struct svc_req *);
...
#define comprimentocirculo 6
extern  int * comprimentocirculo_1();
extern  int * comprimentocirculo_1_svc();
#define areacirculo 7
extern  int * areacirculo_1();
extern  int * areacirculo_1_svc();
